                                        ...
                                        <li class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                ...
                                                <?php if (!empty($top10sp['gia_khuyen_mai']) && $top10sp['gia_khuyen_mai'] < $top10sp['gia_san_pham']): ?>
                                                    <!-- Giá khuyến mại -->
                                                    <span
                                                        class="text-danger fw-bold"><?= fomatPrice($top10sp['gia_khuyen_mai']) ?>₫</span>
                                                    <!-- Giá gốc -->
                                                    <span
                                                        class="text-muted text-decoration-line-through ms-2"><?= fomatPrice($top10sp['gia_san_pham']) ?>₫</span>
                                                <?php else: ?>
                                                    <!-- Giá bình thường -->
                                                    <span
                                                        class="text-danger fw-bold"><?= fomatPrice($top10sp['gia_san_pham']) ?>₫</span>
                                                <?php endif; ?>
                                            </div>
                                        </li>
                                    <?php } ?>
                                    ...
                                    <div class="product-item shadow-sm p-3 mb-5 bg-white rounded">
                                        ...
                                        <div class="product-caption text-center">
                                            ...
                                            <div class="price-box">
                                                <?php if (!empty($sanPham['gia_khuyen_mai']) && $sanPham['gia_khuyen_mai'] < $sanPham['gia_san_pham']): ?>
                                                    <span
                                                        class="price-regular text-success">$<?= fomatPrice($sanPham['gia_khuyen_mai'], 2 . 'Đ') ?></span>
                                                    <span
                                                        class="price-old text-muted"><del>$<?= fomatPrice($sanPham['gia_san_pham'], 2 . 'Đ') ?></del></span>
                                                <?php else: ?>
                                                    <span
                                                        class="price-regular">$<?= fomatPrice($sanPham['gia_san_pham'], 2 . 'Đ') ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
